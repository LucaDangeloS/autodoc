export default {
    ...
    mcpServerDescription: 'Expose autopwndoc over the Model Context Protocol so authorised AI agents can query and update audits, findings, and known vulnerabilities over HTTP.',
    mcpApiKey: 'MCP API Key',
    mcpApiKeyHint: 'Agents must send this key in the X-API-Key header on every MCP request.',
    ...
    mcpSampleConfigHint: 'Copy one of these examples into your agent configuration and replace the host or key if needed.',
    ...
    msg: {
        ...
        allClientsDeleteNotice: 'All Clients will be permanently deleted',
        allClientsDeleteOk: 'All clients deleted successfully',
    ...
    importClientsInfo: `Import Clients from a .yml file.<br />
    ...
    aiProviderDescription: 'Select the AI provider and configure connection details. The API key is stored securely and never exposed to the browser.',
    aiProviderLabel: 'Provider',
    aiModel: 'Model',
    aiModelHint: 'e.g. gpt-4o, claude-sonnet-4-20250514, llama3',
    aiApiUrl: 'API URL',
    aiApiUrlHint: 'Leave empty to use the default endpoint for the selected provider',
    aiApiKey: 'API Key',
    aiApiKeyHint: 'Required for cloud providers (OpenAI, Anthropic, Azure)',
    aiAzureSettings: 'Azure OpenAI Settings',
    aiAzureDeploymentName: 'Deployment Name',
    aiAzureApiVersion: 'API Version',
    aiGenerationParameters: 'Generation Parameters',
    aiGenerationParametersDescription: 'Control how the AI generates text. Lower temperature produces more deterministic output, higher temperature produces more creative output.',
    aiTemperature: 'Temperature',
    aiMaxTokens: 'Max Tokens',
    aiAdvancedSettings: 'Advanced Settings',
    aiAdvancedSettingsDescription: 'Customize the prompts used when generating content with AI. Leave a field empty to use the built-in default.',
    aiPromptAvailableTags: 'Available tags',
    aiPromptSectionGenerate: 'Generate',
    aiPromptSectionGenerateCaption: 'Creates content from scratch for a finding field',
    aiPromptSectionComplete: 'Complete',
    aiPromptSectionCompleteCaption: 'Continues existing content in a finding field',
    aiPromptSectionRewrite: 'Rewrite',
    aiPromptSectionRewriteCaption: 'Rewrites existing content to be clearer and more professional',
    aiPromptSectionFillProofs: 'Fill Proofs',
    aiPromptSectionFillProofsCaption: 'Generates the Proof of Concept narrative from vision-analysed screenshots',
    ...
    aiFieldPromptInheritNote: 'Leave any prompt blank to inherit from the generic action prompt. Only the system prompt can be overridden per field; the user prompt is shared.',
    aiFieldPromptPlaceholder: 'Leave blank to use the generic action prompt…',
    aiFieldPromptResetTooltip: 'Clear this field prompt (will fall back to generic action prompt)',
    ...
    aiSystemPromptHint: 'Instructions that define the AI\'s role and behavior',
    aiUserPrompt: 'User Prompt',
    aiUserPromptHint: 'The prompt template sent with each generation request',
    aiEmbeddingSection: 'Embedding Configuration',
    aiEmbeddingDescription: 'Configure the model used to generate vector embeddings for semantic vulnerability search. This can differ from the generation model.',
    aiEmbeddingProvider: 'Embedding Provider',
    aiEmbeddingModel: 'Embedding Model',
    aiEmbeddingModelHint: 'e.g. text-embedding-3-small, nomic-embed-text',
    aiEmbeddingApiUrl: 'Embedding API URL',
    aiEmbeddingApiUrlHint: 'Base URL of the embedding server (e.g. http://host:1234/v1). Trailing paths like /embeddings or /chat are stripped automatically.',
    aiEmbeddingApiKey: 'Embedding API Key',
    aiEmbeddingApiKeyHint: 'Required for cloud providers (OpenAI, Azure)',
    aiEmbeddingAzureSettings: 'Azure Embedding Settings',
    aiEmbeddingMaxDistance: 'Max Distance',
    aiEmbeddingMaxDistanceHint: 'L2 distance threshold (0 = identical, 2 = very different). Results above this value are filtered out.',
    aiReindexAll: 'Re-index All',
    aiReindexStarted: 'Re-indexing started in background',
    ...
    aiVisionDescription: 'Configure a vision-capable model to analyze proof-of-concept screenshots and generate vulnerability descriptions from images.',
    aiVisionProvider: 'Vision Provider',
    aiVisionModel: 'Vision Model',
    aiVisionModelHint: 'Must be a vision-capable model (e.g. gpt-4o, claude-3-5-sonnet, llava)',
    aiVisionApiUrl: 'Vision API URL',
    aiVisionApiUrlHint: 'Leave empty to use the default endpoint for the selected provider',
    aiVisionApiKey: 'Vision API Key',
    aiVisionApiKeyHint: 'Required for cloud providers (OpenAI, Anthropic, Azure)',
    aiVisionAzureSettings: 'Azure Vision Settings',
    aiVisionAnonymization: 'Anonymization',
    aiVisionAnonymizationDescription: 'Control how sensitive data is redacted from the vision model output before it is used for embedding search.',
    aiVisionAnonymizeLlm: 'LLM anonymization',
    aiVisionAnonymizeLlmHint: 'Ask the model to replace sensitive data (IPs, domains, usernames) with [REDACTED] in its output',
    aiVisionAnonymizeRegex: 'Regex anonymization',
    aiVisionAnonymizeRegexHint: 'Apply pattern-based redaction after LLM output (IPs, emails, domains). Cheaper but less context-aware.',
    aiVisionSystemPrompt: 'Vision System Prompt',
    aiVisionSystemPromptHint: 'Custom instructions for the vision model. Leave empty to use the built-in cybersecurity analyst prompt.',
    searchSimilarFromProofs: 'Search from Proofs',
    proofSearchTitle: 'Search Similar from Proof of Concept',
    proofSearchNeedContent: 'Add some content to the Proofs tab first (images or text)',
    proofAnalysis: 'Proof Analysis',
    proofAnalysisSummary: 'AI Proof Analysis (click to expand)',
    ...
    isRetestHint: 'Enable to add a Retest Evidence tab to each finding',
    ...
    aiReviewHint: 'Compare the previous text with the AI proposal. Edit the proposed text if needed, then apply it.',
